import { composeCodeVisual } from '@/app/meta-agent/feedback-note/code-visual/use'
import { generateFeedbackNoteImage } from '@/app/meta-agent/feedback-note/image'
import type {
...
interface FeedbackNoteRepresentationDependencies {
  composeCodeVisual: typeof composeCodeVisual
  generateImage: typeof generateFeedbackNoteImage
}

const DEFAULT_DEPENDENCIES: FeedbackNoteRepresentationDependencies = {
  composeCodeVisual,
  generateImage: generateFeedbackNoteImage
}

export function createFeedbackNoteRepresentationProvider(
  dependencies: FeedbackNoteRepresentationDependencies = DEFAULT_DEPENDENCIES
): FeedbackNoteRepresentationProvider {
  return {
...
export const FEEDBACK_NOTE_REPRESENTATION_PROVIDER = createFeedbackNoteRepresentationProvider()
