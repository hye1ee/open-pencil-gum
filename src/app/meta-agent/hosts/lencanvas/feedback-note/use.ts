...
import type { FeedbackNote, FeedbackNoteHistoryItem } from '@/app/meta-agent/feedback-note/types'
...
import type { OpenPencilFeedbackNoteInput } from '@/app/meta-agent/hosts/lencanvas/input'
